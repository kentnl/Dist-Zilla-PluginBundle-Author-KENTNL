...
An array of files generated by dzil build to copy from the built dist back to the source dist
...
sub _configure_basic_files {
  ...
  if ( @{ $self->copyfiles } ) {
    $GGD->{exclude_filename} = [ @{ $self->copyfiles } ];
  }
