...
eval { $v .= pmver('Dist::Zilla::Plugin::PodWeaver','3.102000') };
...
eval { $v .= pmver('Dist::Zilla::Plugin::Test::Compile','2.034') };
...
eval { $v .= pmver('Dist::Zilla::Plugin::Twitter','0.022') };
...
eval { $v .= pmver('Perl::PrereqScanner','1.017') };
