...
eval { $v .= pmver('Dist::Zilla::Plugin::ModuleShareDirs','5.005') };
...
eval { $v .= pmver('Dist::Zilla::Plugin::Prereqs::AuthorDeps','0.002') };
...
eval { $v .= pmver('Dist::Zilla::Plugin::RemovePhasedPrereqs','0.002') };
...
eval { $v .= pmver('Module::Build','0.40_09') };
