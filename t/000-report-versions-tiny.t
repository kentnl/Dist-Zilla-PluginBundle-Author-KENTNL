...
eval { $v .= pmver('Dist::Zilla','5.008') };
eval { $v .= pmver('Dist::Zilla::File::FromCode','5.008') };
eval { $v .= pmver('Dist::Zilla::Plugin::Authority','1.006') };
eval { $v .= pmver('Dist::Zilla::Plugin::AutoPrereqs','5.008') };
eval { $v .= pmver('Dist::Zilla::Plugin::Bootstrap::lib','0.04000002') };
eval { $v .= pmver('Dist::Zilla::Plugin::ConfirmRelease','5.008') };
...
eval { $v .= pmver('Dist::Zilla::Plugin::License','5.008') };
eval { $v .= pmver('Dist::Zilla::Plugin::Manifest','5.008') };
eval { $v .= pmver('Dist::Zilla::Plugin::ManifestSkip','5.008') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaConfig','5.008') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaData::BuiltWith','0.04000002') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaJSON','5.008') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaProvides::Package','1.15000001') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaTests','5.008') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaYAML','5.008') };
eval { $v .= pmver('Dist::Zilla::Plugin::MinimumPerl','1.003') };
eval { $v .= pmver('Dist::Zilla::Plugin::ModuleBuild','5.008') };
eval { $v .= pmver('Dist::Zilla::Plugin::NextRelease','5.008') };
eval { $v .= pmver('Dist::Zilla::Plugin::PerlTidy','0.13') };
eval { $v .= pmver('Dist::Zilla::Plugin::PkgVersion','5.008') };
eval { $v .= pmver('Dist::Zilla::Plugin::PodCoverageTests','5.008') };
eval { $v .= pmver('Dist::Zilla::Plugin::PodSyntaxTests','5.008') };
eval { $v .= pmver('Dist::Zilla::Plugin::PodWeaver','4.002') };
eval { $v .= pmver('Dist::Zilla::Plugin::Prereqs','5.008') };
...
eval { $v .= pmver('Dist::Zilla::Plugin::TestRelease','5.008') };
eval { $v .= pmver('Dist::Zilla::Plugin::Twitter','0.024') };
eval { $v .= pmver('Dist::Zilla::Plugin::UploadToCPAN','5.008') };
eval { $v .= pmver('Dist::Zilla::Role::BundleDeps','0.001001') };
eval { $v .= pmver('Dist::Zilla::Role::FileGatherer','5.008') };
eval { $v .= pmver('Dist::Zilla::Role::MintingProfile::ShareDir','5.008') };
eval { $v .= pmver('Dist::Zilla::Role::PluginBundle','5.008') };
