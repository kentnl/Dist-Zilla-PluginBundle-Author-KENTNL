...
eval { $v .= pmver('Dist::Zilla::Plugin::Git::NextRelease','0.002000') };
...
eval { $v .= pmver('Dist::Zilla::Plugin::MetaProvides::Package','1.15000003') };
...
eval { $v .= pmver('IO::Socket::SSL','1.963') };
