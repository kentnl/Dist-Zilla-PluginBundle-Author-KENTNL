...
eval { $v .= pmver('Dist::Zilla::Plugin::License','5.005') };
eval { $v .= pmver('Dist::Zilla::Plugin::Manifest','5.005') };
eval { $v .= pmver('Dist::Zilla::Plugin::ManifestSkip','5.005') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaConfig','5.005') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaData::BuiltWith','0.04000000') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaJSON','5.005') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaProvides','1.15000000') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaProvides::Package','1.15000000') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaTests','5.005') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaYAML','5.005') };
eval { $v .= pmver('Dist::Zilla::Plugin::MinimumPerl','1.003') };
eval { $v .= pmver('Dist::Zilla::Plugin::ModuleBuild','5.005') };
eval { $v .= pmver('Dist::Zilla::Plugin::NextRelease','5.005') };
eval { $v .= pmver('Dist::Zilla::Plugin::PerlTidy','0.13') };
eval { $v .= pmver('Dist::Zilla::Plugin::PkgVersion','5.005') };
eval { $v .= pmver('Dist::Zilla::Plugin::PodCoverageTests','5.005') };
eval { $v .= pmver('Dist::Zilla::Plugin::PodSyntaxTests','5.005') };
eval { $v .= pmver('Dist::Zilla::Plugin::PodWeaver','4.001') };
eval { $v .= pmver('Dist::Zilla::Plugin::Prereqs','5.005') };
eval { $v .= pmver('Dist::Zilla::Plugin::Prereqs::MatchInstalled','v0.1.4') };
eval { $v .= pmver('Dist::Zilla::Plugin::PruneCruft','5.005') };
eval { $v .= pmver('Dist::Zilla::Plugin::ReadmeAnyFromPod','0.131500') };
eval { $v .= pmver('Dist::Zilla::Plugin::ReadmeFromPod','0.20') };
eval { $v .= pmver('Dist::Zilla::Plugin::ReportVersions::Tiny','1.10') };
eval { $v .= pmver('Dist::Zilla::Plugin::Test::CPAN::Changes','0.008') };
eval { $v .= pmver('Dist::Zilla::Plugin::Test::Compile','2.037') };
...
eval { $v .= pmver('Dist::Zilla::Plugin::TestRelease','5.005') };
eval { $v .= pmver('Dist::Zilla::Plugin::Twitter','0.023') };
eval { $v .= pmver('Dist::Zilla::Plugin::UploadToCPAN','5.005') };
eval { $v .= pmver('Dist::Zilla::Role::BundleDeps','0.001000') };
eval { $v .= pmver('Dist::Zilla::Role::FileGatherer','5.005') };
eval { $v .= pmver('Dist::Zilla::Role::MintingProfile::ShareDir','5.005') };
eval { $v .= pmver('Dist::Zilla::Role::PluginBundle','5.005') };
...
eval { $v .= pmver('Pod::Weaver::Plugin::Encoding','0.02') };
eval { $v .= pmver('String::Formatter','0.102082') };
eval { $v .= pmver('Test::CPAN::Meta','0.23') };
eval { $v .= pmver('Test::DZil','5.005') };
