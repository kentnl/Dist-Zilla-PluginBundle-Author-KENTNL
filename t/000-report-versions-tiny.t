...
eval { $v .= pmver('Dist::Zilla::Plugin::CheckExtraTests','0.016') };
...
eval { $v .= pmver('Dist::Zilla::Plugin::Git::NextVersion','2.019') };
...
eval { $v .= pmver('Dist::Zilla::Plugin::Prereqs::MatchInstalled','v0.1.5') };
eval { $v .= pmver('Dist::Zilla::Plugin::PruneCruft','5.006') };
eval { $v .= pmver('Dist::Zilla::Plugin::ReadmeAnyFromPod','0.133290') };
