...
eval { $v .= pmver('Dist::Zilla::Plugin::Prereqs::MatchInstalled','v0.1.2') };
eval { $v .= pmver('Dist::Zilla::Plugin::Prereqs::MatchInstalled::All','v0.1.1') };
eval { $v .= pmver('Dist::Zilla::Plugin::Prereqs::Plugins','v0.1.2') };
...
eval { $v .= pmver('Dist::Zilla::Plugin::Test::Compile','2.031') };
...
eval { $v .= pmver('Test::Fatal','0.012') };
eval { $v .= pmver('Test::File::ShareDir','v0.3.3') };
eval { $v .= pmver('Test::Kwalitee','1.14') };
