...
eval { $v .= pmver('Dist::Zilla::Plugin::MetaProvides::Package','1.15000001') };
...
eval { $v .= pmver('Dist::Zilla::Plugin::NextRelease','5.009') };
...
eval { $v .= pmver('Moose::Util::TypeConstraints','2.1200') };
