...
eval { $v .= pmver('Carp','1.29') };
eval { $v .= pmver('Class::Load','0.20') };
eval { $v .= pmver('Dist::Zilla::File::FromCode','4.300035') };
eval { $v .= pmver('Dist::Zilla::Plugin::Author::KENTNL::MinimumPerl','v1.7.7') };
...
eval { $v .= pmver('Dist::Zilla::Plugin::ConfirmRelease','4.300035') };
eval { $v .= pmver('Dist::Zilla::Plugin::EOLTests','0.02') };
eval { $v .= pmver('Dist::Zilla::Plugin::FinderCode','4.300035') };
...
eval { $v .= pmver('Dist::Zilla::Plugin::GithubMeta','0.30') };
eval { $v .= pmver('Dist::Zilla::Plugin::License','4.300035') };
eval { $v .= pmver('Dist::Zilla::Plugin::Manifest','4.300035') };
eval { $v .= pmver('Dist::Zilla::Plugin::ManifestSkip','4.300035') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaConfig','4.300035') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaData::BuiltWith','0.03000100') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaJSON','4.300035') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaProvides::Package','1.14000003') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaTests','4.300035') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaYAML','4.300035') };
eval { $v .= pmver('Dist::Zilla::Plugin::MinimumPerl','1.003') };
eval { $v .= pmver('Dist::Zilla::Plugin::ModuleBuild','4.300035') };
eval { $v .= pmver('Dist::Zilla::Plugin::ModuleShareDirs','4.300035') };
eval { $v .= pmver('Dist::Zilla::Plugin::NextRelease','4.300035') };
eval { $v .= pmver('Dist::Zilla::Plugin::PkgVersion','4.300035') };
eval { $v .= pmver('Dist::Zilla::Plugin::PodCoverageTests','4.300035') };
eval { $v .= pmver('Dist::Zilla::Plugin::PodSyntaxTests','4.300035') };
eval { $v .= pmver('Dist::Zilla::Plugin::PodWeaver','3.101642') };
eval { $v .= pmver('Dist::Zilla::Plugin::Prereqs','4.300035') };
...
eval { $v .= pmver('Dist::Zilla::Plugin::PruneCruft','4.300035') };
...
eval { $v .= pmver('Dist::Zilla::Plugin::Test::Compile','2.018') };
...
eval { $v .= pmver('Dist::Zilla::PluginBundle::Author::KENTNL','v1.7.7') };
...
eval { $v .= pmver('Test::CPAN::Changes','0.22') };
eval { $v .= pmver('Test::CPAN::Meta','0.23') };
eval { $v .= pmver('Test::DZil','4.300035') };
