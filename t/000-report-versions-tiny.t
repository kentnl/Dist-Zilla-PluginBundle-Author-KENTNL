...
eval { $v .= pmver('Dist::Zilla::Plugin::Git::Check','2.006') };
eval { $v .= pmver('Dist::Zilla::Plugin::Git::CommitBuild','2.006') };
eval { $v .= pmver('Dist::Zilla::Plugin::Git::GatherDir','2.006') };
eval { $v .= pmver('Dist::Zilla::Plugin::Git::NextVersion','2.006') };
eval { $v .= pmver('Dist::Zilla::Plugin::Git::Tag','2.006') };
