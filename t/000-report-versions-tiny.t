...
eval { $v .= pmver('Dist::Zilla::Plugin::Authority','1.007') };
...
eval { $v .= pmver('Dist::Zilla::Plugin::Prereqs::MatchInstalled','v0.1.0') };
...
eval { $v .= pmver('Dist::Zilla::PluginBundle::Author::KENTNL','v1.7.6') };
