...
eval { $v .= pmver('Dist::Zilla::Plugin::AutoVersion::Relative','0.01034313') };
eval { $v .= pmver('Dist::Zilla::Plugin::CompileTests','1.101800') };
eval { $v .= pmver('Dist::Zilla::Plugin::EOLTests','0.02') };
eval { $v .= pmver('Dist::Zilla::Plugin::Git','1.102040') };
eval { $v .= pmver('Dist::Zilla::Plugin::GithubMeta','0.08') };
eval { $v .= pmver('Dist::Zilla::Plugin::KwaliteeTests','1.101420') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaData::BuiltWith','0.01005122') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaProvides','1.11034201') };
eval { $v .= pmver('Dist::Zilla::Plugin::MetaProvides::Package','1.11034304') };
