...
my $static_prereqs = do { my $x = {
       ...
       'develop' => {
                      'requires' => {
                                      ...
                                      'Dist::Zilla::Plugin::ModuleShareDirs' => '5.013',
       ...
       'runtime' => {
                      ...
                      'requires' => {
                                      'Carp' => '0',
                                      'Dist::Zilla' => '5.013',
                                      'Dist::Zilla::File::FromCode' => '5.013',
                                      ...
                                      'Dist::Zilla::Role::FileGatherer' => '5.013',
                                      'Dist::Zilla::Role::MintingProfile::ShareDir' => '5.013',
                                      'Dist::Zilla::Role::PluginBundle' => '5.013',
