...
my $static_prereqs = do { my $x = {
       ...
       'develop' => {
                      'requires' => {
                                      ...
                                      'Dist::Zilla::Plugin::ModuleShareDirs' => '5.012',
       ...
       'runtime' => {
                      ...
                      'requires' => {
                                      'Carp' => '0',
                                      'Dist::Zilla' => '5.012',
                                      'Dist::Zilla::File::FromCode' => '5.012',
                                      ...
                                      'Dist::Zilla::Role::FileGatherer' => '5.012',
                                      'Dist::Zilla::Role::MintingProfile::ShareDir' => '5.012',
                                      'Dist::Zilla::Role::PluginBundle' => '5.012',
